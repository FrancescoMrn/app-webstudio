...
export function ChatPanel({
  ...
  useEffect(() => { onChatIdRef.current = onChatId }, [onChatId])
  ...
  useEffect(() => {
    ...
    window.mobius.chat({
      ...
      // Surface the resolved chat id so the app can post annotation comments
      // into this exact conversation.
      try { onChatIdRef.current?.(nextHandle.chatId) } catch { /* ignore */ }
    }).catch((e) => {
